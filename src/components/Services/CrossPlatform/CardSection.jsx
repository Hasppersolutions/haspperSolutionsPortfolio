...
const features = [
  { title: "React Native Development and Design", description: "We build modern and scalable apps.", icon: <img src= {icon1}></img> },
  { title: "React Native Consulting", description: "Get professional advice for your app.", icon: "🎧" },
  { title: "React Native Migration", description: "Smooth transitions to React Native.", icon: "📤" },
  { title: "Support and Maintenance", description: "Keep your app running smoothly.", icon: "🛠️" },
  { title: "Custom React Native Solutions", description: "Tailored solutions for your business.", icon: "🧩" },
  { title: "App Testing", description: "Ensure quality with thorough testing.", icon: "✅" },
  { title: "Deployment Assistance", description: "Launch your app successfully.", icon: "🚀" },
  { title: "Post-Launch Support", description: "Ongoing support after launch.", icon: "💼" },
];
