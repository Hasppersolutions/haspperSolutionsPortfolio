...
const features = [
  { title: "React Native Development and Design", description: "We build modern and scalable apps.", icon: <img src= {DevelopmentDesign} style={{ width: '80px', height: '80px' }}></img>},
  { title: "React Native Consulting", description: "Get professional advice for your app.", icon: <img src= {Consulting} style={{ width: '80px', height: '80px' }}></img>  },
  { title: "React Native Migration", description: "Smooth transitions to React Native.", icon: <img src= {Migration} style={{ width: '80px', height: '80px' }}></img>  },
  { title: "Support and Maintenance", description: "Keep your app running smoothly.", icon: <img src= {Maintainance} style={{ width: '80px', height: '80px' }}></img> },
  { title: "Custom React Native Solutions", description: "Tailored solutions for your business.", icon: <img src= {MobileApps} style={{ width: '80px', height: '80px' }}></img> },
  { title: "App Testing", description: "Ensure quality with thorough testing.", icon: <img src= {Testing} style={{ width: '80px', height: '80px' }}></img>  },
  { title: "Deployment Assistance", description: "Launch your app successfully.", icon: <img src= {Deployment} style={{ width: '80px', height: '80px' }}></img> },
  { title: "Post-Launch Support", description: "Ongoing support after launch.", icon: <img src= {LaunchSupport} style={{ width: '80px', height: '80px' }}></img>  },
];
