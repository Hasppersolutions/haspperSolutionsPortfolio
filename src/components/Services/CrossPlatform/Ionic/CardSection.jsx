...
const features = [
  { title: "Custom Ionic App Development", description: "We build modern and scalable apps.", icon: <img src= {DevelopmentDesign} style={{ width: '80px', height: '80px' }}></img>},
  { title: "Ionic App Design", description: "Get professional advice for your app.", icon: <img src= {Consulting} style={{ width: '80px', height: '80px' }}></img>  },
  { title: "Ionic App Migration", description: "Smooth transitions to React Native.", icon: <img src= {Migration} style={{ width: '80px', height: '80px' }}></img>  },
  { title: "Ionic Widget Development", description: "Keep your app running smoothly.", icon: <img src= {Maintainance} style={{ width: '80px', height: '80px' }}></img> },
  { title: "QA & Testing", description: "Tailored solutions for your business.", icon: <img src= {MobileApps} style={{ width: '80px', height: '80px' }}></img> },
