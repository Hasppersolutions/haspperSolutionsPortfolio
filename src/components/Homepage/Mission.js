    ...
    <Box sx={{ py: 8, backgroundColor: '#f5f5f5' }}>
      <Container>
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Typography
            variant="body1"
            sx={{ color: '#616161', maxWidth: '800px', margin: '0 auto' }}
          >
        ...
        <Grid container spacing={4} justifyContent="center">
          ...
          <Grid size={{xs:12,md:6}}>
            <Box sx={{ display: 'flex', alignItems: 'center', p: 2 }}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mr: 2 }}>
                <img src="/path/to/mission_icon.png" alt="Mission" width="80px" />
              </Box>
            </Box>
          </Grid>
          ...
          <Grid size={{xs:12,md:6}}>
            <Box sx={{ display: 'flex', alignItems: 'center', p: 2 }}>
              {/* Vision Image */}
              <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mr: 2 }}>
                <img src="/path/to/vision_icon.png" alt="Vision" width="80px" />
              </Box>
