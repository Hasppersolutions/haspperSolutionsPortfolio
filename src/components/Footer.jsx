  ...
  return (
    <footer style={styles.footerContainer}>
      ...
      <div style={styles.centerLinks}>
        <a href="http://localhost:3000/glossary" target="_blank" rel="noopener noreferrer" style={styles.link}>Glossary</a>|
        <a href="http://localhost:3000/blog" target="_blank" rel="noopener noreferrer" style={styles.link}>Blog</a>|
