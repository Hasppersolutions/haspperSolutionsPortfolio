...
const technologyData = [
  {
    name: "Languages",
    imgData: [html, python, java, objectC, swift],
  },
  {
    name: "Framework",
    imgData: [angularJs, phoneGap, flutter, xamarin, ionic, node, laravel],
  },
  {
    name: "Database",
    ...
    [
      {
        ...
        description: `Harness the cloud’s scalability and flexibility to fuel your startup’s growth and agility.`,
      },
      {
        image: blockchian,
        title: "Blockchain Consulting Services",
        description: `With our specialized blockchain consulting, we help you discover new prospects in the crypto realm.`,
      },
    ],
    [
      {
        ...
        description: `Utilize AI for smart automation, data analysis, and consumer interactions, revolutionizing your startup’s capabilities.`,
      },
      {
        image: iot,
        title: "Internet of Things (IoT)",
        description: `Connect devices and systems seamlessly, opening new avenues for control and data collection.`,
      },
    ],
  ],
};
const faqData = {
  faqItems: [
    {
      question: "Q. What is a typical timeline for a startup project?",
      answer:
    ...
    {
      question: "Q. Do you offer post-launch support?",
      answer:
    ...
    {
      question: "Q. How scalable are your solutions?",
      answer:
    ...
    {
      question: "Q. What's your payment structure?",
      answer:
