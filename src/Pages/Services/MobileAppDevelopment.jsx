...
const featuresData = {
  description: `Haspper is a premier agile custom mobile app development company that provides cutting-edge and innovative mobile app development services to businesses of all sizes and industries.<br />
  ...
  Businesses that partner with Haspper for their bespoke mobile app development needs are confident that the final product will fulfill their business objectives and be of the highest quality.`,
  featuresList: [
...
const developmentServicesData = {
  ...
  cardData: [
    ...
    },
    {
      ...
      description: `Hire mobile app developer from Haspper to get complete assistance for adding new features, updating the user experience, and improving speed and security to modernize websites into mobile apps.`,
    },
  ],
};
